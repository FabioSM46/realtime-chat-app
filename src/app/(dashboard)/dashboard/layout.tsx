...
const Layout = async ({ children }: LayoutProps) => {
  ...
  return (
    <div className="w-full flex h-screen">
      <div
        className="flex h-full w-full max-w-xs grow flexcol 
      gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6"
      >
                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <li key={option.id}>
                      ...
                      hover:bg-gray-50 group flex gap-3 rounded-md p-2 text-sm 
                      leading6 font font-semibold"
                      >
                        <span
